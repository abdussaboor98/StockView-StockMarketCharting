...
export class UpdateExchangeComponent implements OnInit {
  ...
  constructor(private formBuilder : FormBuilder, private stockExService : StockExchangesService, private router: Router) { }
  ...
  onSubmit(){
    this.stockExService.updateStockExchange(this.updateExchangeForm.value).subscribe(data=>{
